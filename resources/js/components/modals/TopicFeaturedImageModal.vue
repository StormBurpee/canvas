...
<script>
    ...
    export default {
        name: 'topic-featured-image-modal',
        ...
        mounted() {
            this.selectedImageUrl = this.activeTopic.featured_image
            this.selectedImageCaption = this.activeTopic.featured_image_caption
            this.isReadyToAcceptUploads = isEmpty(this.activeTopic.featured_image);
        },
        ...
        methods: {
            ...
            clickDone() {
                this.activeTopic.featured_image = !isEmpty(this.selectedImageUrl) ? this.selectedImageUrl : ''
