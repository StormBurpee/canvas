...
<script>
    ...
    export default {
        ...
        mounted() {
            this.selectedImageUrl = this.activeTag.featured_image
            this.selectedImageCaption = this.activeTag.featured_image_caption
            this.isReadyToAcceptUploads = isEmpty(this.activeTag.featured_image);
        },
        ...
        methods: {
            ...
            clickDone() {
                this.activeTag.featured_image = !isEmpty(this.selectedImageUrl) ? this.selectedImageUrl : ''
